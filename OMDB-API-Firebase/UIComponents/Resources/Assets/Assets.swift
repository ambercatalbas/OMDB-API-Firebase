...
public enum Asset {
  public enum Colors {
    ...
    public static let appBeige = ColorAsset(name: "appBeige")
  ...
  public enum Icons {
    public static let addIcon = ImageAsset(name: "add-icon")
    public static let arrowIcon = ImageAsset(name: "arrow-icon")
    public static let backArrow = ImageAsset(name: "back-arrow")
    public static let checkIcon = ImageAsset(name: "check-icon")
    public static let crossIcon = ImageAsset(name: "cross-icon")
    public static let editIcon = ImageAsset(name: "edit-icon")
    public static let hamburgerIcon = ImageAsset(name: "hamburger-icon")
    public static let searchIcon = ImageAsset(name: "search-icon")
    public static let trashIcon = ImageAsset(name: "trash-icon")
  }
  public enum Images {
    public static let imgBg = ImageAsset(name: "img_bg")
    public static let imgGirl = ImageAsset(name: "img_girl")
  }
}
